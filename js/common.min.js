...
!function(e,n){"use strict";"function"==typeof define&&define.amd?define(["jquery"],function(o){return n(o,e,e.document,e.Math)}):"object"==typeof exports&&exports?module.exports=n(require("jquery"),e,e.document,e.Math):n(jQuery,e,e.document,e.Math)}("undefined"!=typeof window?window:this,function(e,n,o,t,i){"use strict";var a="fullpage-wrapper",l="."+a,r="fp-responsive",s="fp-notransition",c="fp-destroyed",d="fp-enabled",f="fp-viewing",u="active",h="."+u,v="fp-completely",p="."+v,g="fp-section",m="."+g,w=m+h,S=m+":first",x=m+":last",b="fp-tableCell",y="."+b,C="fp-auto-height",T="fp-normal-scroll",k="fp-nav",L="#"+k,A="fp-tooltip",O="."+A,I="fp-show-active",E="fp-slide",M="."+E,B=M+h,R="fp-slides",z="."+R,H="fp-slidesContainer",P="."+H,D="fp-table",q="fp-slidesNav",F="."+q,V=F+" a",j=".fp-controlArrow",Y="fp-prev",N="fp-controlArrow "+Y,U=j+("."+Y),X="fp-controlArrow fp-next",W=j+".fp-next",K=e(n),_=e(o);e.fn.fullpage=function(Q){function G(n,o){n||un(0),gn("autoScrolling",n,o);var t=e(w);Q.autoScrolling&&!Q.scrollBar?(Sn.css({overflow:"hidden",height:"100%"}),J(Xn.recordHistory,"internal"),In.css({"-ms-touch-action":"none","touch-action":"none"}),t.length&&un(t.position().top)):(Sn.css({overflow:"visible",height:"initial"}),J(!1,"internal"),In.css({"-ms-touch-action":"","touch-action":""}),t.length&&Sn.scrollTop(t.position().top))}function J(e,n){gn("recordHistory",e,n)}function Z(e,n){gn("scrollingSpeed",e,n)}function $(e,n){gn("fitToSection",e,n)}function ee(e){e?(!function(){var e,t="";n.addEventListener?e="addEventListener":(e="attachEvent",t="on");var a="onwheel"in o.createElement("div")?"wheel":o.onmousewheel!==i?"mousewheel":"DOMMouseScroll";"DOMMouseScroll"==a?o[e](t+"MozMousePixelScroll",be,!1):o[e](t+a,be,!1)}(),In.on("mousedown",qe).on("mouseup",Fe)):(o.addEventListener?(o.removeEventListener("mousewheel",be,!1),o.removeEventListener("wheel",be,!1),o.removeEventListener("MozMousePixelScroll",be,!1)):o.detachEvent("onmousewheel",be),In.off("mousedown",qe).off("mouseup",Fe))}function ne(n,o){void 0!==o?(o=o.replace(/ /g,"").split(","),e.each(o,function(e,o){vn(n,o,"m")})):(vn(n,"all","m"),n?(ee(!0),(An||On)&&(Q.autoScrolling&&xn.off(Un.touchmove).on(Un.touchmove,ge),e(l).off(Un.touchstart).on(Un.touchstart,Se).off(Un.touchmove).on(Un.touchmove,me))):(ee(!1),(An||On)&&(Q.autoScrolling&&xn.off(Un.touchmove),e(l).off(Un.touchstart).off(Un.touchmove))))}function oe(n,o){void 0!==o?(o=o.replace(/ /g,"").split(","),e.each(o,function(e,o){vn(n,o,"k")})):(vn(n,"all","k"),Q.keyboardScrolling=n)}function te(){var n=e(w).prev(m);n.length||!Q.loopTop&&!Q.continuousVertical||(n=e(m).last()),n.length&&Te(n,null,!0)}function ie(){var n=e(w).next(m);n.length||!Q.loopBottom&&!Q.continuousVertical||(n=e(m).first()),n.length&&Te(n,null,!1)}function ae(e,n){Z(0,"internal"),le(e,n),Z(Xn.scrollingSpeed,"internal")}function le(e,n){var o=on(e);void 0!==n?tn(e,n):o.length>0&&Te(o)}function re(e){ye("right",e)}function se(e){ye("left",e)}function ce(n){if(!In.hasClass(c)){Mn=!0,En=K.height(),e(m).each(function(){var n=e(this).find(z),o=e(this).find(M);Q.verticalCentered&&e(this).find(y).css("height",en(e(this))+"px"),e(this).css("height",En+"px"),o.length>1&&Xe(n,n.find(B))}),Q.scrollOverflow&&Pn.createScrollBarForAll();var o=e(w).index(m);o&&ae(o+1),Mn=!1,e.isFunction(Q.afterResize)&&n&&Q.afterResize.call(In),e.isFunction(Q.afterReBuild)&&!n&&Q.afterReBuild.call(In)}}function de(n){var o=xn.hasClass(r);n?o||(G(!1,"internal"),$(!1,"internal"),e(L).hide(),xn.addClass(r),e.isFunction(Q.afterResponsive)&&Q.afterResponsive.call(In,n)):o&&(G(Xn.autoScrolling,"internal"),$(Xn.autoScrolling,"internal"),e(L).show(),xn.removeClass(r),e.isFunction(Q.afterResponsive)&&Q.afterResponsive.call(In,n))}function fe(){Q.css3&&(Q.css3=function(){var e,t=o.createElement("p"),a={webkitTransform:"-webkit-transform",OTransform:"-o-transform",msTransform:"-ms-transform",MozTransform:"-moz-transform",transform:"transform"};o.body.insertBefore(t,null);for(var l in a)t.style[l]!==i&&(t.style[l]="translate3d(1px,1px,1px)",e=n.getComputedStyle(t).getPropertyValue(a[l]));return o.body.removeChild(t),e!==i&&e.length>0&&"none"!==e}()),Q.scrollBar=Q.scrollBar||Q.hybrid,function(){var n=In.find(Q.sectionSelector);Q.anchors.length||(Q.anchors=n.filter("[data-anchor]").map(function(){return e(this).data("anchor").toString()}).get());Q.navigationTooltips.length||(Q.navigationTooltips=n.filter("[data-tooltip]").map(function(){return e(this).data("tooltip").toString()}).get())}(),function(){In.css({height:"100%",position:"relative"}),In.addClass(a),e("html").addClass(d),En=K.height(),In.removeClass(c),In.find(Q.sectionSelector).addClass(g),In.find(Q.slideSelector).addClass(E),e(m).each(function(n){var o=e(this),t=o.find(M),i=t.length;!function(n,o){o||0!==e(w).length||n.addClass(u),kn=e(w),n.css("height",En+"px"),Q.paddingTop&&n.css("padding-top",Q.paddingTop),Q.paddingBottom&&n.css("padding-bottom",Q.paddingBottom),void 0!==Q.sectionsColor[o]&&n.css("background-color",Q.sectionsColor[o]),void 0!==Q.anchors[o]&&n.attr("data-anchor",Q.anchors[o])}(o,n),function(n,o){void 0!==Q.anchors[o]&&n.hasClass(u)&&Je(Q.anchors[o],o),Q.menu&&Q.css3&&e(Q.menu).closest(l).length&&e(Q.menu).appendTo(xn)}(o,n),i>0?function(n,o,t){var i=100*t,a=100/t;o.wrapAll('<div class="'+H+'" />'),o.parent().wrap('<div class="'+R+'" />'),n.find(P).css("width",i+"%"),t>1&&(Q.controlArrows&&function(e){e.find(z).after('<div class="'+N+'"></div><div class="'+X+'"></div>'),"#fff"!=Q.controlArrowColor&&(e.find(W).css("border-color","transparent transparent transparent "+Q.controlArrowColor),e.find(U).css("border-color","transparent "+Q.controlArrowColor+" transparent transparent")),Q.loopHorizontal||e.find(U).hide()}(n),Q.slidesNavigation&&function(e,n){e.append('<div class="'+q+'"><ul></ul></div>');var o=e.find(F);o.addClass(Q.slidesNavPosition);for(var t=0;t<n;t++)o.find("ul").append('<li><a href="#"><span></span></a></li>');o.css("margin-left","-"+o.width()/2+"px"),o.find("li").first().find("a").addClass(u)}(n,t)),o.each(function(n){e(this).css("width",a+"%"),Q.verticalCentered&&$e(e(this))});var l=n.find(B);l.length&&(0!==e(w).index(m)||0===e(w).index(m)&&0!==l.index())?fn(l,"internal"):o.eq(0).addClass(u)}(o,t,i):Q.verticalCentered&&$e(o)}),Q.fixedElements&&Q.css3&&e(Q.fixedElements).appendTo(xn);Q.navigation&&function(){xn.append('<div id="'+k+'"><ul></ul></div>');var n=e(L);n.addClass(function(){return Q.showActiveTooltip?I+" "+Q.navigationPosition:Q.navigationPosition});for(var o=0;o<e(m).length;o++){var t="";Q.anchors.length&&(t=Q.anchors[o]);var i='<li><a href="#'+t+'"><span></span></a>',a=Q.navigationTooltips[o];void 0!==a&&""!==a&&(i+='<div class="'+A+" "+Q.navigationPosition+'">'+a+"</div>"),i+="</li>",n.find("ul").append(i)}e(L).css("margin-top","-"+e(L).height()/2+"px"),e(L).find("li").eq(e(w).index(m)).find("a").addClass(u)}();In.find('iframe[src*="youtube.com/embed/"]').each(function(){!function(e,n){var o=e.attr("src");e.attr("src",o+(/\?/.test(o)?"&":"?")+n)}(e(this),"enablejsapi=1")}),Q.scrollOverflow?Pn=Q.scrollOverflowHandler.init(Q):ue()}(),ne(!0),G(Q.autoScrolling,"internal"),_e(),cn(),"complete"===o.readyState&&Be(),K.on("load",Be)}function ue(){var n=e(w);n.addClass(v),Ae(n),Oe(n),Q.scrollOverflow&&Q.scrollOverflowHandler.afterLoad(),function(){var e=on(ze().section);return!e.length||e.length&&e.index()===kn.index()}()&&e.isFunction(Q.afterLoad)&&Q.afterLoad.call(n,n.data("anchor"),n.index(m)+1),e.isFunction(Q.afterRender)&&Q.afterRender.call(In)}function he(){var n;if(!Q.autoScrolling||Q.scrollBar){var t=K.scrollTop(),i=function(e){var n=e>Kn?"down":"up";return Kn=e,$n=e,n}(t),a=0,l=t+K.height()/2,r=xn.height()-K.height()===t,s=o.querySelectorAll(m);if(r)a=s.length-1;else if(t)for(var c=0;c<s.length;++c){s[c].offsetTop<=l&&(a=c)}else a=0;if(function(n){var o=e(w).position().top,t=o+K.height();if("up"==n)return t>=K.scrollTop()+K.height();return o<=K.scrollTop()}(i)&&(e(w).hasClass(v)||e(w).addClass(v).siblings().removeClass(v)),!(n=e(s).eq(a)).hasClass(u)){Wn=!0;var d,f,h=e(w),p=h.index(m)+1,g=Ze(n),S=n.data("anchor"),x=n.index(m)+1,b=n.find(B);b.length&&(f=b.data("anchor"),d=b.index()),Rn&&(n.addClass(u).siblings().removeClass(u),e.isFunction(Q.onLeave)&&Q.onLeave.call(h,p,x,g),e.isFunction(Q.afterLoad)&&Q.afterLoad.call(n,S,x),Ee(h),Ae(n),Oe(n),Je(S,x-1),Q.anchors.length&&(yn=S),ln(d,f,S,x)),clearTimeout(Vn),Vn=setTimeout(function(){Wn=!1},100)}Q.fitToSection&&(clearTimeout(jn),jn=setTimeout(function(){Q.fitToSection&&e(w).outerHeight()<=En&&ve()},Q.fitToSectionDelay))}}function ve(){Rn&&(Mn=!0,Te(e(w)),Mn=!1)}function pe(n){if(Hn.m[n]){var o="down"===n?ie:te;if(Q.scrollOverflow){var t=Q.scrollOverflowHandler.scrollable(e(w)),i="down"===n?"bottom":"top";if(t.length>0){if(!Q.scrollOverflowHandler.isScrolled(i,t))return!0;o()}else o()}else o()}}function ge(e){var n=e.originalEvent;Q.autoScrolling&&we(n)&&e.preventDefault()}function me(n){var o=n.originalEvent,i=e(o.target).closest(m);if(we(o)){Q.autoScrolling&&n.preventDefault();var a=dn(o);Gn=a.y,Jn=a.x,i.find(z).length&&t.abs(Qn-Jn)>t.abs(_n-Gn)?!Ln&&t.abs(Qn-Jn)>K.outerWidth()/100*Q.touchSensitivity&&(Qn>Jn?Hn.m.right&&re(i):Hn.m.left&&se(i)):Q.autoScrolling&&Rn&&t.abs(_n-Gn)>K.height()/100*Q.touchSensitivity&&(_n>Gn?pe("down"):Gn>_n&&pe("up"))}}function we(e){return void 0===e.pointerType||"mouse"!=e.pointerType}function Se(e){var n=e.originalEvent;if(Q.fitToSection&&Sn.stop(),we(n)){var o=dn(n);_n=o.y,Qn=o.x}}function xe(e,n){for(var o=0,i=e.slice(t.max(e.length-n,1)),a=0;a<i.length;a++)o+=i[a];return t.ceil(o/n)}function be(o){var i=(new Date).getTime(),a=e(p).hasClass(T);if(Q.autoScrolling&&!Tn&&!a){var l=(o=o||n.event).wheelDelta||-o.deltaY||-o.detail,r=t.max(-1,t.min(1,l)),s=void 0!==o.wheelDeltaX||void 0!==o.deltaX,c=t.abs(o.wheelDeltaX)<t.abs(o.wheelDelta)||t.abs(o.deltaX)<t.abs(o.deltaY)||!s;zn.length>149&&zn.shift(),zn.push(t.abs(l)),Q.scrollBar&&(o.preventDefault?o.preventDefault():o.returnValue=!1);var d=i-Zn;if(Zn=i,d>200&&(zn=[]),Rn){xe(zn,10)>=xe(zn,70)&&c&&pe(r<0?"down":"up")}return!1}Q.fitToSection&&Sn.stop()}function ye(n,o){var t=(void 0===o?e(w):o).find(z),i=t.find(M).length;if(!(!t.length||Ln||i<2)){var a=t.find(B),l=null;if(!(l="left"===n?a.prev(M):a.next(M)).length){if(!Q.loopHorizontal)return;l="left"===n?a.siblings(":last"):a.siblings(":first")}Ln=!0,Xe(t,l,n)}}function Ce(){e(B).each(function(){fn(e(this),"internal")})}function Te(n,o,i){if(void 0!==n){var a,r,s={element:n,callback:o,isMovementUp:i,dtop:function(e){var n=e.position(),o=n.top,t=n.top>$n,i=o-En+e.outerHeight(),a=Q.bigSectionsDestination;return e.outerHeight()>En?(t||a)&&"bottom"!==a||(o=i):(t||Mn&&e.is(":last-child"))&&(o=i),$n=o,o}(n),yMovement:Ze(n),anchorLink:n.data("anchor"),sectionIndex:n.index(m),activeSlide:n.find(B),activeSection:e(w),leavingSection:e(w).index(m)+1,localIsResizing:Mn};s.activeSection.is(n)&&!Mn||Q.scrollBar&&K.scrollTop()===s.dtop&&!n.hasClass(C)||(s.activeSlide.length&&(a=s.activeSlide.data("anchor"),r=s.activeSlide.index()),e.isFunction(Q.onLeave)&&!s.localIsResizing&&!1===Q.onLeave.call(s.activeSection,s.leavingSection,s.sectionIndex+1,s.yMovement)||(Q.autoScrolling&&Q.continuousVertical&&void 0!==s.isMovementUp&&(!s.isMovementUp&&"up"==s.yMovement||s.isMovementUp&&"down"==s.yMovement)&&(s=function(n){n.isMovementUp?e(w).before(n.activeSection.nextAll(m)):e(w).after(n.activeSection.prevAll(m).get().reverse());return un(e(w).position().top),Ce(),n.wrapAroundElements=n.activeSection,n.dtop=n.element.position().top,n.yMovement=Ze(n.element),n.leavingSection=n.activeSection.index(m)+1,n.sectionIndex=n.element.index(m),n}(s)),s.localIsResizing||Ee(s.activeSection),Q.scrollOverflow&&Q.scrollOverflowHandler.beforeLeave(),n.addClass(u).siblings().removeClass(u),Ae(n),Q.scrollOverflow&&Q.scrollOverflowHandler.onLeave(),Rn=!1,ln(r,a,s.anchorLink,s.sectionIndex),function(n){if(Q.css3&&Q.autoScrolling&&!Q.scrollBar){nn("translate3d(0px, -"+t.round(n.dtop)+"px, 0px)",!0),Q.scrollingSpeed?(clearTimeout(qn),qn=setTimeout(function(){ke(n)},Q.scrollingSpeed)):ke(n)}else{var o=function(e){var n={};Q.autoScrolling&&!Q.scrollBar?(n.options={top:-e.dtop},n.element=l):(n.options={scrollTop:e.dtop},n.element="html, body");return n}(n);e(o.element).animate(o.options,Q.scrollingSpeed,Q.easing).promise().done(function(){Q.scrollBar?setTimeout(function(){ke(n)},30):ke(n)})}}(s),yn=s.anchorLink,Je(s.anchorLink,s.sectionIndex)))}}function ke(n){!function(n){n.wrapAroundElements&&n.wrapAroundElements.length&&(n.isMovementUp?e(S).before(n.wrapAroundElements):e(x).after(n.wrapAroundElements),un(e(w).position().top),Ce())}(n),e.isFunction(Q.afterLoad)&&!n.localIsResizing&&Q.afterLoad.call(n.element,n.anchorLink,n.sectionIndex+1),Q.scrollOverflow&&Q.scrollOverflowHandler.afterLoad(),n.localIsResizing||Oe(n.element),n.element.addClass(v).siblings().removeClass(v),Rn=!0,e.isFunction(n.callback)&&n.callback.call(this)}function Le(e,n){e.attr(n,e.data(n)).removeAttr("data-"+n)}function Ae(n){if(Q.lazyLoading){var o;Me(n).find("img[data-src], img[data-srcset], source[data-src], video[data-src], audio[data-src], iframe[data-src]").each(function(){if(o=e(this),e.each(["src","srcset"],function(e,n){var t=o.attr("data-"+n);void 0!==t&&t&&Le(o,n)}),o.is("source")){var n=o.closest("video").length?"video":"audio";o.closest(n).get(0).load()}})}}function Oe(n){var o=Me(n);o.find("video, audio").each(function(){var n=e(this).get(0);n.hasAttribute("data-autoplay")&&"function"==typeof n.play&&n.play()}),o.find('iframe[src*="youtube.com/embed/"]').each(function(){var n=e(this).get(0);n.hasAttribute("data-autoplay")&&Ie(n),n.onload=function(){n.hasAttribute("data-autoplay")&&Ie(n)}})}function Ie(e){e.contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}',"*")}function Ee(n){var o=Me(n);o.find("video, audio").each(function(){var n=e(this).get(0);n.hasAttribute("data-keepplaying")||"function"!=typeof n.pause||n.pause()}),o.find('iframe[src*="youtube.com/embed/"]').each(function(){var n=e(this).get(0);/youtube\.com\/embed\//.test(e(this).attr("src"))&&!n.hasAttribute("data-keepplaying")&&e(this).get(0).contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}',"*")})}function Me(n){var o=n.find(B);return o.length&&(n=e(o)),n}function Be(){var e=ze(),n=e.section,o=e.slide;n&&(Q.animateAnchor?tn(n,o):ae(n,o))}function Re(){if(!Wn&&!Q.lockAnchors){var e=ze(),n=e.section,o=e.slide,t=void 0===yn,i=void 0===yn&&void 0===o&&!Ln;n.length&&(n&&n!==yn&&!t||i||!Ln&&Cn!=o)&&tn(n,o)}}function ze(){var e=n.location.hash,o=e.replace("#","").split("/"),t=e.indexOf("#/")>-1;return{section:t?"/"+o[1]:decodeURIComponent(o[0]),slide:t?decodeURIComponent(o[2]):decodeURIComponent(o[1])}}function He(n){clearTimeout(Yn);var o=e(":focus");if(!o.is("textarea")&&!o.is("input")&&!o.is("select")&&"true"!==o.attr("contentEditable")&&""!==o.attr("contentEditable")&&Q.keyboardScrolling&&Q.autoScrolling){var t=n.which;e.inArray(t,[40,38,32,33,34])>-1&&n.preventDefault(),Tn=n.ctrlKey,Yn=setTimeout(function(){!function(n){var o=n.shiftKey;if(!Rn&&[37,39].indexOf(n.which)<0)return;switch(n.which){case 38:case 33:Hn.k.up&&te();break;case 32:if(o&&Hn.k.up){te();break}case 40:case 34:Hn.k.down&&ie();break;case 36:Hn.k.up&&le(1);break;case 35:Hn.k.down&&le(e(m).length);break;case 37:Hn.k.left&&se();break;case 39:Hn.k.right&&re();break;default:;}}(n)},150)}}function Pe(){e(this).prev().trigger("click")}function De(e){Bn&&(Tn=e.ctrlKey)}function qe(e){2==e.which&&(eo=e.pageY,In.on("mousemove",Ue))}function Fe(e){2==e.which&&In.off("mousemove")}function Ve(){var n=e(this).closest(m);e(this).hasClass(Y)?Hn.m.left&&se(n):Hn.m.right&&re(n)}function je(){Bn=!1,Tn=!1}function Ye(n){n.preventDefault();var o=e(this).parent().index();Te(e(m).eq(o))}function Ne(n){n.preventDefault();var o=e(this).closest(m).find(z);Xe(o,o.find(M).eq(e(this).closest("li").index()))}function Ue(e){Rn&&(e.pageY<eo&&Hn.m.up?te():e.pageY>eo&&Hn.m.down&&ie()),eo=e.pageY}function Xe(n,o,i){var a=n.closest(m),l={slides:n,destiny:o,direction:i,destinyPos:o.position(),slideIndex:o.index(),section:a,sectionIndex:a.index(m),anchorLink:a.data("anchor"),slidesNav:a.find(F),slideAnchor:sn(o),prevSlide:a.find(B),prevSlideIndex:a.find(B).index(),localIsResizing:Mn};l.xMovement=function(e,n){if(e==n)return"none";if(e>n)return"left";return"right"}(l.prevSlideIndex,l.slideIndex),l.localIsResizing||(Rn=!1),Q.onSlideLeave&&!l.localIsResizing&&"none"!==l.xMovement&&e.isFunction(Q.onSlideLeave)&&!1===Q.onSlideLeave.call(l.prevSlide,l.anchorLink,l.sectionIndex+1,l.prevSlideIndex,l.direction,l.slideIndex)?Ln=!1:(o.addClass(u).siblings().removeClass(u),l.localIsResizing||(Ee(l.prevSlide),Ae(o)),!Q.loopHorizontal&&Q.controlArrows&&(a.find(U).toggle(0!==l.slideIndex),a.find(W).toggle(!o.is(":last-child"))),a.hasClass(u)&&!l.localIsResizing&&ln(l.slideIndex,l.slideAnchor,l.anchorLink,l.sectionIndex),function(e,n,o){var i=n.destinyPos;if(Q.css3){var a="translate3d(-"+t.round(i.left)+"px, 0px, 0px)";Qe(e.find(P)).css(hn(a)),Fn=setTimeout(function(){o&&We(n)},Q.scrollingSpeed,Q.easing)}else e.animate({scrollLeft:t.round(i.left)},Q.scrollingSpeed,Q.easing,function(){o&&We(n)})}(n,l,!0))}function We(n){!function(e,n){e.find(h).removeClass(u),e.find("li").eq(n).find("a").addClass(u)}(n.slidesNav,n.slideIndex),n.localIsResizing||(e.isFunction(Q.afterSlideLoad)&&Q.afterSlideLoad.call(n.destiny,n.anchorLink,n.sectionIndex+1,n.slideAnchor,n.slideIndex),Rn=!0,Oe(n.destiny)),Ln=!1}function Ke(){if(_e(),An){var n=e(o.activeElement);if(!n.is("textarea")&&!n.is("input")&&!n.is("select")){var i=K.height();t.abs(i-no)>20*t.max(no,i)/100&&(ce(!0),no=i)}}else clearTimeout(Dn),Dn=setTimeout(function(){ce(!0)},350)}function _e(){var e=Q.responsive||Q.responsiveWidth,n=Q.responsiveHeight,o=e&&K.outerWidth()<e,t=n&&K.height()<n;e&&n?de(o||t):e?de(o):n&&de(t)}function Qe(e){var n="all "+Q.scrollingSpeed+"ms "+Q.easingcss3;return e.removeClass(s),e.css({"-webkit-transition":n,transition:n})}function Ge(e){return e.addClass(s)}function Je(n,o){!function(n){Q.menu&&(e(Q.menu).find(h).removeClass(u),e(Q.menu).find('[data-menuanchor="'+n+'"]').addClass(u))}(n),function(n,o){Q.navigation&&(e(L).find(h).removeClass(u),n?e(L).find('a[href="#'+n+'"]').addClass(u):e(L).find("li").eq(o).find("a").addClass(u))}(n,o)}function Ze(n){var o=e(w).index(m),t=n.index(m);return o==t?"none":o>t?"up":"down"}function $e(e){e.hasClass(D)||e.addClass(D).wrapInner('<div class="'+b+'" style="height:'+en(e)+'px;" />')}function en(e){var n=En;if(Q.paddingTop||Q.paddingBottom){var o=e;o.hasClass(g)||(o=e.closest(m));var t=parseInt(o.css("padding-top"))+parseInt(o.css("padding-bottom"));n=En-t}return n}function nn(e,n){n?Qe(In):Ge(In),In.css(hn(e)),setTimeout(function(){In.removeClass(s)},10)}function on(n){if(!n)return[];var o=In.find(m+'[data-anchor="'+n+'"]');return o.length||(o=e(m).eq(n-1)),o}function tn(e,n){var o=on(e);o.length&&(void 0===n&&(n=0),e===yn||o.hasClass(u)?an(o,n):Te(o,function(){an(o,n)}))}function an(e,n){if(void 0!==n){var o=e.find(z),t=function(e,n){var o=n.find(z),t=o.find(M+'[data-anchor="'+e+'"]');return t.length||(t=o.find(M).eq(e)),t}(n,e);t.length&&Xe(o,t)}}function ln(e,n,o,t){var i="";Q.anchors.length&&!Q.lockAnchors&&(e?(void 0!==o&&(i=o),void 0===n&&(n=e),Cn=n,rn(i+"/"+n)):void 0!==e?(Cn=n,rn(o)):rn(o)),cn()}function rn(e){if(Q.recordHistory)location.hash=e;else if(An||On)n.history.replaceState(i,i,"#"+e);else{var o=n.location.href.split("#")[0];n.location.replace(o+"#"+e)}}function sn(e){var n=e.data("anchor"),o=e.index();return void 0===n&&(n=o),n}function cn(){var n=e(w),o=n.find(B),t=sn(n),i=sn(o),a=String(t);o.length&&(a=a+"-"+i),a=a.replace("/","-").replace("#","");var l=new RegExp("\\b\\s?"+f+"-[^\\s]+\\b","g");xn[0].className=xn[0].className.replace(l,""),xn.addClass(f+"-"+a)}function dn(e){var n=[];return n.y=void 0!==e.pageY&&(e.pageY||e.pageX)?e.pageY:e.touches[0].pageY,n.x=void 0!==e.pageX&&(e.pageY||e.pageX)?e.pageX:e.touches[0].pageX,On&&we(e)&&Q.scrollBar&&(n.y=e.touches[0].pageY,n.x=e.touches[0].pageX),n}function fn(e,n){Z(0,"internal"),void 0!==n&&(Mn=!0),Xe(e.closest(z),e),void 0!==n&&(Mn=!1),Z(Xn.scrollingSpeed,"internal")}function un(e){var n=t.round(e);if(Q.css3&&Q.autoScrolling&&!Q.scrollBar){nn("translate3d(0px, -"+n+"px, 0px)",!1)}else Q.autoScrolling&&!Q.scrollBar?In.css("top",-n):Sn.scrollTop(n)}function hn(e){return{"-webkit-transform":e,"-moz-transform":e,"-ms-transform":e,transform:e}}function vn(n,o,t){"all"!==o?Hn[t][o]=n:e.each(Object.keys(Hn[t]),function(e,o){Hn[t][o]=n})}function pn(n){G(!1,"internal"),ne(!1),oe(!1),In.addClass(c),clearTimeout(Fn),clearTimeout(qn),clearTimeout(Dn),clearTimeout(Vn),clearTimeout(jn),K.off("scroll",he).off("hashchange",Re).off("resize",Ke),_.off("click touchstart",L+" a").off("mouseenter",L+" li").off("mouseleave",L+" li").off("click touchstart",V).off("mouseover",Q.normalScrollElements).off("mouseout",Q.normalScrollElements),e(m).off("click touchstart",j),clearTimeout(Fn),clearTimeout(qn),n&&function(){un(0),In.find("img[data-src], source[data-src], audio[data-src], iframe[data-src]").each(function(){Le(e(this),"src")}),In.find("img[data-srcset]").each(function(){Le(e(this),"srcset")}),e(L+", "+F+", "+j).remove(),e(m).css({height:"","background-color":"",padding:""}),e(M).css({width:""}),In.css({height:"",position:"","-ms-touch-action":"","touch-action":""}),Sn.css({overflow:"",height:""}),e("html").removeClass(d),xn.removeClass(r),e.each(xn.get(0).className.split(/\s+/),function(e,n){0===n.indexOf(f)&&xn.removeClass(n)}),e(m+", "+M).each(function(){Q.scrollOverflowHandler&&Q.scrollOverflowHandler.remove(e(this)),e(this).removeClass(D+" "+u)}),Ge(In),In.find(y+", "+P+", "+z).each(function(){e(this).replaceWith(this.childNodes)}),In.css({"-webkit-transition":"none",transition:"none"}),Sn.scrollTop(0);var n=[g,E,H];e.each(n,function(n,o){e("."+o).removeClass(o)})}()}function gn(e,n,o){Q[e]=n,"internal"!==o&&(Xn[e]=n)}function mn(){e("html").hasClass(d)?wn("error","Fullpage.js can only be initialized once and you are doing it multiple times!"):(Q.continuousVertical&&(Q.loopTop||Q.loopBottom)&&(Q.continuousVertical=!1,wn("warn","Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),Q.scrollBar&&Q.scrollOverflow&&wn("warn","Option `scrollBar` is mutually exclusive with `scrollOverflow`. Sections with scrollOverflow might not work well in Firefox"),!Q.continuousVertical||!Q.scrollBar&&Q.autoScrolling||(Q.continuousVertical=!1,wn("warn","Scroll bars (`scrollBar:true` or `autoScrolling:false`) are mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),Q.scrollOverflow&&!Q.scrollOverflowHandler&&(Q.scrollOverflow=!1,wn("error","The option `scrollOverflow:true` requires the file `scrolloverflow.min.js`. Please include it before fullPage.js.")),e.each(["fadingEffect","continuousHorizontal","scrollHorizontally","interlockedSlides","resetSliders","responsiveSlides","offsetSections","dragAndMove","scrollOverflowReset","parallax"],function(e,n){Q[n]&&wn("warn","fullpage.js extensions require jquery.fullpage.extensions.min.js file instead of the usual jquery.fullpage.js. Requested: "+n)}),e.each(Q.anchors,function(n,o){var t=_.find("[name]").filter(function(){return e(this).attr("name")&&e(this).attr("name").toLowerCase()==o.toLowerCase()}),i=_.find("[id]").filter(function(){return e(this).attr("id")&&e(this).attr("id").toLowerCase()==o.toLowerCase()});(i.length||t.length)&&(wn("error","data-anchor tags can not have the same value as any `id` element on the site (or `name` element for IE)."),i.length&&wn("error",'"'+o+'" is is being used by another element `id` property'),t.length&&wn("error",'"'+o+'" is is being used by another element `name` property'))}))}function wn(e,n){console&&console[e]&&console[e]("fullPage: "+n)}if(e("html").hasClass(d))mn();else{var Sn=e("html, body"),xn=e("body"),bn=e.fn.fullpage;Q=e.extend({menu:!1,anchors:[],lockAnchors:!1,navigation:!1,navigationPosition:"right",navigationTooltips:[],showActiveTooltip:!1,slidesNavigation:!1,slidesNavPosition:"bottom",scrollBar:!1,hybrid:!1,css3:!0,scrollingSpeed:700,autoScrolling:!0,fitToSection:!0,fitToSectionDelay:1e3,easing:"easeInOutCubic",easingcss3:"ease",loopBottom:!1,loopTop:!1,loopHorizontal:!0,continuousVertical:!1,continuousHorizontal:!1,scrollHorizontally:!1,interlockedSlides:!1,dragAndMove:!1,offsetSections:!1,resetSliders:!1,fadingEffect:!1,normalScrollElements:null,scrollOverflow:!1,scrollOverflowReset:!1,scrollOverflowHandler:e.fn.fp_scrolloverflow?e.fn.fp_scrolloverflow.iscrollHandler:null,scrollOverflowOptions:null,touchSensitivity:5,normalScrollElementTouchThreshold:5,bigSectionsDestination:null,keyboardScrolling:!0,animateAnchor:!0,recordHistory:!0,controlArrows:!0,controlArrowColor:"#fff",verticalCentered:!0,sectionsColor:[],paddingTop:0,paddingBottom:0,fixedElements:null,responsive:0,responsiveWidth:0,responsiveHeight:0,responsiveSlides:!1,parallax:!1,parallaxOptions:{type:"reveal",percentage:62,property:"translate"},sectionSelector:".section",slideSelector:".slide",afterLoad:null,onLeave:null,afterRender:null,afterResize:null,afterReBuild:null,afterSlideLoad:null,onSlideLeave:null,afterResponsive:null,lazyLoading:!0},Q);var yn,Cn,Tn,kn,Ln=!1,An=navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/),On="ontouchstart"in n||navigator.msMaxTouchPoints>0||navigator.maxTouchPoints,In=e(this),En=K.height(),Mn=!1,Bn=!0,Rn=!0,zn=[],Hn={};Hn.m={up:!0,down:!0,left:!0,right:!0},Hn.k=e.extend(!0,{},Hn.m);var Pn,Dn,qn,Fn,Vn,jn,Yn,Nn=n.PointerEvent?{down:"pointerdown",move:"pointermove"}:{down:"MSPointerDown",move:"MSPointerMove"},Un={touchmove:"ontouchmove"in n?"touchmove":Nn.move,touchstart:"ontouchstart"in n?"touchstart":Nn.down},Xn=e.extend(!0,{},Q);mn(),e.extend(e.easing,{easeInOutCubic:function(e,n,o,t,i){return(n/=i/2)<1?t/2*n*n*n+o:t/2*((n-=2)*n*n+2)+o}}),e(this).length&&(bn.version="2.9.5",bn.setAutoScrolling=G,bn.setRecordHistory=J,bn.setScrollingSpeed=Z,bn.setFitToSection=$,bn.setLockAnchors=function(e){Q.lockAnchors=e},bn.setMouseWheelScrolling=ee,bn.setAllowScrolling=ne,bn.setKeyboardScrolling=oe,bn.moveSectionUp=te,bn.moveSectionDown=ie,bn.silentMoveTo=ae,bn.moveTo=le,bn.moveSlideRight=re,bn.moveSlideLeft=se,bn.fitToSection=ve,bn.reBuild=ce,bn.setResponsive=de,bn.destroy=pn,bn.shared={afterRenderActions:ue},fe(),K.on("scroll",he).on("hashchange",Re).blur(je).resize(Ke),_.keydown(He).keyup(De).on("click touchstart",L+" a",Ye).on("click touchstart",V,Ne).on("click",O,Pe),e(m).on("click touchstart",j,Ve),Q.normalScrollElements&&(_.on("mouseenter touchstart",Q.normalScrollElements,function(){ne(!1)}),_.on("mouseleave touchend",Q.normalScrollElements,function(){ne(!0)})));var Wn=!1,Kn=0,_n=0,Qn=0,Gn=0,Jn=0,Zn=(new Date).getTime(),$n=0,eo=0,no=En}}});
...
!function(e){e(document).ready(function(){e("#fullpage").fullpage({sectionsColor:["","","","","","",""],anchors:["firstPage","secondPage","3rdPage","4rdPage","5rdPage"],menu:"#menu",scrollBar:!1,navigation:!0,navigationTooltips:["Главная","О нас","Услуги и цены","Как работаем","Контакты"],scrollOverflow:!1})});var a=e(".recall"),l=e(".hamburger");l.on("click",function(){e(this).toggleClass("open"),e(".header__menu").toggleClass("flex_menu"),a.hasClass("recall_all_up")&&a.removeClass("recall_all_up")}),e(window).on("load resize",function(){e(window).outerWidth()<="768"&&(e(".header__menu").removeClass("flex_menu"),e(".hamburger").removeClass("open"))}),setTimeout(function(){e(".recall").addClass("recall_up")},7e3),e(".recall__link").on("click",function(){e(this).parent().toggleClass("recall_all_up"),l.hasClass("open")&&(l.removeClass("open"),e(".header__menu").removeClass("flex_menu"))});e(".two_prices__items").each(function(){var a;location.hash&&(a=e(this).find('[href="'+location.hash+'"]').parent()),location.hash&&a.length||(a=e(this).children("li:first")),a.siblings().each(function(){e(e(this).children("a").attr("href")).hide()})});e(".two_nav__items a").on("click",function(a){a.preventDefault(),e(e(this).attr("href")).show(),e(e(this).parent().addClass("active").siblings(".active").removeClass("active").children("a").attr("href")).hide()}),e(".phone_mask").mask("+38 (000) 000-00-00")}(jQuery);